        ...
        <van-pull-refresh v-model="isLoading"
          ...
          <li>五</li>
            ...
            <div class="date_content"
                ...
                <div :class="{checkActive:index2 == num}"
                     class="item"
        ...
        getDayInfo () {
            ...
            Api.getTodayData(this.userPreInterviewId).then((res) => {
                if (res.code == 200 && res.data != "") {
                    ...
                    console.log('日数据状态', this.num)
                    this.userPreInterviewDetailId ? this.userPreInterviewDetailId = this.userPreInterviewDetailId : this.userPreInterviewDetailId = this.todayData[0].userPreInterviewDetailId;
                    this.status == ""
            ...
            .checkDays {
                ...
                .active {
                    ...
                    .dayTime {
                        ...
                        line-height: 0.56rem;
                        text-align: center;
                        border: 1px solid rgba(248, 213, 126, 1);
                        background: rgba(248, 213, 126, 1);
                        border-radius: 0.16rem;
                    }
                    .status {
