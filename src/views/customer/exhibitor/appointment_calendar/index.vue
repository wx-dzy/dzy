<template>
  ...
  <div class="appointment_calendar">
    ...
    <div class="year_month">
      ...
      <span class="right" @click="weekNext"></span>
     <van-field
      class="select_type"
      readonly
      clickable
    ...
    <van-pull-refresh v-model="isLoading" @refresh="onRefresh" class="push_box">
      ...
      <p class="refreshTip"><van-icon name="replay" class="replay_icon" />下拉刷新</p>
    </van-pull-refresh>
...
.appointment_calendar {
  ...
  .top_header::after{
        ...
        background:linear-gradient(180deg,rgba(248,213,126,1) 0%,rgba(255,255,255,1) 100%);
  }
  .year_month{
    transform: translateY(-0.82rem);
    display: flex;
