<template>
  ...
  <div class="appointment_calendar">
    <div class="top_header">
      <img :src="userInfo.avatar" class="head_img" alt />
    ...
    <van-pull-refresh v-model="isLoading" @refresh="onRefresh" class="push_box">
      <div class="date">
        ...
        <ul class="days">
          <!-- 星期 -->
          <ul class="weekdays">
            <li class="weekends" v-for="(item,index) in weekListShow" :key="index">
      ...
      Api.getTodayData(this.userPreInterviewId).then((res) => {
        if (res.code == 200 && res.data != "") {
          ...
          this.userPreInterviewDetailId
            ? (this.userPreInterviewDetailId = this.userPreInterviewDetailId)
