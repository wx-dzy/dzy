...
export default {
  ...
  data() {
    return {
      ...
      pageNum: 1,
      zzz: {
        enterpriseId: "1284852017403052034",
        enterpriseName: "乐蜂日化有限公司",
        enterpriseShowPlaceId: "1285029040926867458",
        enterpriseShowPlaceName: "美妆日用",
        followTimes: 5,
        id: "1285029633410052097",
        logo:
          "https://dzy-cloud-files.oss-cn-hangzhou.aliyuncs.com/files/lefeng/%E4%B9%90%E8%9C%82/%E4%BC%81%E4%B8%9A/%E4%B9%90%E8%9C%82LOGO.jpg",
        orderTimes: 4,
      },
    };
  },
  ...
  methods: {
    ...
    let obj = {
        ...
        orderTimes: 4,
            ...
            for (var i = 0; i < 10; i++ ) {
              obj.enterpriseName = "name" + _this.pageNum + "_" + i;
              obj.id = "id99" + "" + _this.pageNum + "_" + i;
              aaa.push(obj);
            }
            data = aaa
            debugger;
