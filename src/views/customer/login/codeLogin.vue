    ...
    wechatLogin() {
      ...
      Api.loginInit(params)
        .then((res) => {
          ...
          if (res.code == 200) {
            let { accessToken, firstLogin, userId, username } = res.data;
      ...
      if (!this.headimgurl || !this.nickname) {
        Api.getUserInfo(this.openId).then((res) => {
          ...
          if (res.code == 200) {
            ...
            localStorage.setItem("dzy_wxInfo", JSON.stringify(wxInfo), 7);
            // location.reload()
          }
        });
      }
      ...
      Api.codeInit(params)
        .then((res) => {
          ...
          if (res.code == 417) {
            ...
            localStorage.setItem("dzy_userInfo", JSON.stringify(data), 7);
