    ...
    methods: {
        ...
        getCode() {
            ...
            if (!code) {
                ...
                // window.location.href = 'http://www.dzy315.com/get-weixin-code.html?appid=wxc7ed228b39eec84c&scope=snsapi_base&state=123&redirect_uri=http://www.dzy315.com/codeLogin&response_type=code'
                // 本地公用地址
