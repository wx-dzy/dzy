  ...
  <div class="MTaddMember">
    <van-form @submit="addMember">
      ...
      <div class="departments">
        <van-field label="部门" v-model="setIndex" placeholder="选填" />
        <button @click="setMem">设置部门</button>
      </div>
        ...
        <div class="wrapper" @click="IsSetMem = false">
          <div class="block">
            <div class="setBox">
              ...
              <van-radio-group v-model="setIndex">
                <van-radio :name="setIndex" v-for="(item,setIndex) in setList" :key="setIndex">
                  <span class="left_img">
                    <i class="iconfont">&#xe672;</i>
                  </span>
                  <span class="setText">{{item.text}}</span>
