        ...
        <van-pull-refresh v-model="refreshing">
            <van-row class="info">
                ...
                <van-col span="14">
                    ...
                    <span v-show="detail.userInfo.authStatus ==0 || detail.userInfo.authStatus==1"
                          class="status">{{detail.userInfo.authStatus == 1 ? '已认证' : detail.userInfo.authStatus == 0 ? '未认证' : '' }}</span>
                </van-col>
                <van-col span="5"
                         class="text-right"
                         @click="handleSetInfo">
            ...
            <div class="visitingCard"
                 v-if="detail.userCardList.length">
                <visitingCard :dataList.sync="detail.userCardList"
                              :disabled="true"
                              @successCBK="handleActive"></visitingCard>
            </div>
            ...
            <div class="myOrder">
                        ...
                        <van-cell v-for="(item, index)  in listData"
                            ...
                            <van-row class="item_i"
                                ...
                                <van-col span="6">
                                    ...
                                    <img :src="_item.interviewUserLogo"
                                         alt
                                         class="photo" />
                                </van-col>
                                <van-col span="18"
                                    ...
                                    <p class="color999 clearfix">
                                        ...
                                        <van-button round
                                                    ...
                                                    :disabled="!_item.id"
                                                    class="pull-right"
                                                    @click.stop="handleCancel(_item)">{{ _item.id ? '取消预约' : '已取消'}}</van-button>
                                    </p>
                                </van-col>
                            </van-row>
                        </van-cell>
                ...
                <div class="vist">
                    ...
                    <van-list v-model="loading"
                              ...
                              error-text="请求失败，点击重新加载">
                        <van-cell v-for="(item, index)  in listData2"
                                  :key="index"
                                  class="contItem"
                                ...
                                <van-col span="19"
                                    ...
                                    <p class="color999 clearfix">
                                        ...
                                        <van-button round
                                                    ...
                                                    :disabled="!item.id"
                                                    class="pull-right"
                                                    @click="cancelVisit(item)">{{ item.status == 1? '已申请':item.status == 2? '已通过' :item.status == 3? '已拒绝' :item.status == 4? '已取消' :item.status == 5? '已结束':''}}</van-button>
                                    </p>
                                </van-col>
                            </van-row>
                        </van-cell>
            ...
            <ul class="btnWrap clearfix">
                ...
                <li class="item pull-left"
                    ...
                    <img src="@/assets/images/myOrderBg1.png"
                         alt />
                </li>
                <li class="item pull-right"
                    @click="hanleLook(2)">
                    <p class="text pad48">询价单</p>
                    <img src="@/assets/images/myOrderBg2.png"
                         alt />
                </li>
            </ul>
        </van-pull-refresh>
